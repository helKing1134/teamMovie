...
<div class="container">
    ...
    <form method="post" action="/inquiry/submit" enctype="multipart/form-data">
        <div class="row">
        ...
        <div class="input-group">
            <label for="password">비밀번호 (답변 확인용)</label>
            <input type="password" id="password" name="password" required />
            <div class="warning">* 1:1 문의에 대한 보호를 위해 게시글 비밀번호를 설정해주세요.</div>
        </div>
