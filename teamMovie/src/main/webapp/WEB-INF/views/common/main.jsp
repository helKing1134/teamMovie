...
body {
	...
	background: linear-gradient(to right, #111 0%, #1c1c1c 20%, #2a2a2a 50%, #1c1c1c 80%
		, #111 100%);
	color: #ffffff;
}
...
<c:forEach var="movie" items="${mlist}" varStatus="status">
    <div class="movie-card">
        <div class="poster-wrapper">
            ...
            <!-- 포스터 임의로 하드코딩 -->
            <img
							src="https://www.themoviedb.org/t/p/w600_and_h900_bestv2/ylFyiOl7w6tMIWYV4ZAa2HpThhk.jpg"
							alt="${movie.movieTitle} 포스터" class="movie-poster static" />
                 
            <!-- GIF 이미지 : hover 시에만 보임 -->
            
            <!-- GIF 임의로 하드코딩 -->
            <img
							src="https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExMmJudjExanoydHJ6YWlmdmdtdGFuZnF0cm90Z3Yxbnl6d29wbHN5cCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/9Zma6yZTtPOYVUAAb3/giphy.gif"
							alt="${movie.movieTitle} GIF" class="movie-poster hover-gif" />
        </div>
       <!-- 예매 버튼 -->
        <div class="movie-info">
            <div class="movie-title">${movie.movieTitle}</div>
            <a href="/teammovie/movie/select?movieNo=${movie.movieId}"
...
<div id="videoCarousel" class="carousel slide" data-ride="carousel"
		style="background:#ffffff; padding: 40px 0; position: relative;"
		data-interval="20000">
    <div class="carousel-inner text-center">
        <div class="carousel-item active">
            <iframe width="600" height="300"
					src="https://www.youtube.com/embed/LEjhY15eCx0?enablejsapi=1"
					frameborder="0" allowfullscreen></iframe>
            <h5 class="mt-3">Inside Out 2</h5>
        </div>
        <div class="carousel-item">
            <iframe width="600" height="300"
					src="https://www.youtube.com/embed/uJMCNJP2ipI?enablejsapi=1"
					frameborder="0" allowfullscreen></iframe>
            <h5 class="mt-3">Deadpool & Wolverine</h5>
        </div>
        <div class="carousel-item">
			<iframe width="600" height="300"
					src="https://www.youtube.com/embed/9ESZQPX3ewA?enablejsapi=1"
					frameborder="0" allowfullscreen></iframe>
    ...
    <div style="text-align:center; margin-top: 10px;">
        <div
				style="width: 600px; height: 4px; background:#eee; margin: 5px auto 0 auto; border-radius:2px; overflow:hidden;">
            <div id="progressBar"
					style="height:100%; width:0%; background:rgba(0,0,0,0.5);"></div>
        </div>
    </div>
    ...
    <a class="carousel-control-prev" href="#videoCarousel" role="button"
        ...
        <span class="carousel-control-prev-icon"
			style="filter: invert(1);" aria-hidden="true"></span>
